...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a Student's t distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating Student's t distributed pseudorandom numbers.
	*/
